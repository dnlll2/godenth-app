...
const FORMACAO_POR_PROFISSAO: any = {
  'Cirurgião-Dentista': {
    ...
    posGraduacoes: ['Esp: Implantodontia','Esp: Ortodontia','Esp: Endodontia','Esp: Periodontia','Esp: Odontopediatria','Esp: Estética','Esp: Cirurgia Oral','Esp: Prótese Dentária','Esp: HOF','Esp: Odontogeriatria','MBA em Gestão de Clínicas'],
  },
  'Técnico em Prótese Dentária': {
    tipo: 'tecnico',
    cursoTecnico: 'Curso Técnico em Prótese Dentária',
    cursosExtras: ['CAD/CAM','Cerâmica Avançada','Zircônia e e.max','Impressão 3D','Overdenture','Prótese sobre Implante'],
  },
  'Técnico em Saúde Bucal (TSB)': {
    tipo: 'tecnico',
    cursoTecnico: 'Curso Técnico em Saúde Bucal',
    cursosExtras: ['Radiologia','Biossegurança','Atendimento ao Paciente','Primeiros Socorros'],
  },
  'Auxiliar em Saúde Bucal (ASB)': {
    tipo: 'tecnico',
    cursoTecnico: 'Certificado ASB',
    cursosExtras: ['Biossegurança','Atendimento ao Paciente','Primeiros Socorros'],
  },
  'Auxiliar de Prótese Dentária': {
    tipo: 'tecnico',
    cursoTecnico: 'Curso Auxiliar de Prótese Dentária',
    cursosExtras: ['Gesso e Acabamento','CAD/CAM Básico'],
  },
  'Gerente Comercial': { tipo: 'superior', graduacao: 'Graduação em Administração / Gestão / Farmácia', posGraduacoes: ['MBA em Vendas','MBA em Gestão de Equipes','MBA em Liderança'] },
  'Representante Comercial': { tipo: 'superior', graduacao: 'Graduação em Administração / Farmácia / Odontologia', posGraduacoes: ['MBA em Vendas','Curso: Técnicas de Negociação','Curso: Produtos Odontológicos'] },
  'Consultor de Vendas': { tipo: 'superior', graduacao: 'Graduação em Administração / Farmácia', posGraduacoes: ['MBA em Vendas','Curso: CRM','Curso: Inside Sales'] },
  'CRC / Call Center': { tipo: 'tecnico', cursoTecnico: 'Curso de Atendimento ao Cliente', cursosExtras: ['Scripts de Vendas','Retenção de Clientes','WhatsApp Business'] },
  'Recepcionista / Secretária': { tipo: 'tecnico', cursoTecnico: 'Técnico em Secretariado', cursosExtras: ['Atendimento ao Cliente','CRM','Faturamento Odontológico','Software Odontológico'] },
  'Gerente Administrativo': { tipo: 'superior', graduacao: 'Graduação em Administração', posGraduacoes: ['MBA em Gestão em Saúde','MBA em Liderança'] },
  ...
  'Financeiro': { tipo: 'superior', graduacao: 'Graduação em Ciências Contábeis / Administração', posGraduacoes: ['MBA em Finanças','MBA em Controladoria','Curso: Excel Avançado','Curso: ERP'] },
  'RH / Recursos Humanos': { tipo: 'superior', graduacao: 'Graduação em RH / Psicologia / Administração', posGraduacoes: ['MBA em Gestão de Pessoas','Curso: Coaching','Curso: eSocial'] },
